...
// CryptoRandomBytes provides a mock function with given fields: max
func (_m *MockRandomGenerator) CryptoRandomBytes(max int) ([]byte, error) {
	ret := _m.Called(max)
...
//   - max int
func (_e *MockRandomGenerator_Expecter) CryptoRandomBytes(max interface{}) *MockRandomGenerator_CryptoRandomBytes_Call {
	return &MockRandomGenerator_CryptoRandomBytes_Call{Call: _e.mock.On("CryptoRandomBytes", max)}
}

func (_c *MockRandomGenerator_CryptoRandomBytes_Call) Run(run func(max int)) *MockRandomGenerator_CryptoRandomBytes_Call {
