...
type BaseClient interface {
	...
	Encrypt(ctx context.Context, source []byte, ec suite.EncryptionContext, materialsManager materials.CryptoMaterialsManager, optFns ...EncryptOptionFunc) ([]byte, *serialization.MessageHeader, error)
	EncryptWithParams(ctx context.Context, source []byte, ec suite.EncryptionContext, materialsManager materials.CryptoMaterialsManager, algorithm *suite.AlgorithmSuite, frameLength int) ([]byte, *serialization.MessageHeader, error)
...
func (c *Client) EncryptWithParams(ctx context.Context, source []byte, ec suite.EncryptionContext, materialsManager materials.CryptoMaterialsManager, algorithm *suite.AlgorithmSuite, frameLength int) ([]byte, *serialization.MessageHeader, error) {
...
func (c *Client) Encrypt(ctx context.Context, source []byte, ec suite.EncryptionContext, materialsManager materials.CryptoMaterialsManager, optFns ...EncryptOptionFunc) ([]byte, *serialization.MessageHeader, error) {
	opts := EncryptOptions{
